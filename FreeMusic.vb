...
#Region "Private helpers"
    ...
    Private Function GetSong(ByVal audioRow As String) As Song
        ...
        song.Title = TextInTag(audioRow, "<span class=""title", "<span class=""user")
...
#Region "Public subclasses"
    ...
    Public Class Song
        ...
        Property Quantity As Integer = 1
        Property Artist As String = "-"
        Property Title As String = "-"
        Property Duration As Integer = 0
        Property Size As Integer = 0
        Property Bitrate As Integer = 0
